...
*[PENDING: Awaiting details on]*
1. Data cleaning and organization steps/workflow
2. Lead attribution logic and calculations
3. Additional transformations needed for final funnel view
4. Specific CRM system name and API structure
5. Complete list of lead sources
